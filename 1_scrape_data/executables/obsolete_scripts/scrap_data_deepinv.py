...
def download(client, invitation):
    """
    Main function for downloading conference submissions, reviews, and
    meta reviews, and organize them by forum ID
    ...
    # commentsp = openreview.tools.iterget_notes(client=client,
    # invitation=invitation + '/-/Paper.*/Public_Comment')
    # commentsp_by_forum = defaultdict(list)
    # for commentp in commentsp:
    #     commentsp_by_forum[commentp.forum].append(commentp)
    ...
    for forum in submissions_by_forum:
        ...
        try:
            ...
            print("NO submission_url in comment")
        ...
        with open("../data/NeurIPS.cc2019_Deep_Inverse_data/" + file_name + '_' + str(forum) + '.json', 'w') as file_handle:  # noqa
            file_handle.write(json.dumps(forum_metadata))
        # local test
        # break


neurips_19_list = ['NeurIPS.cc/2019/Workshop/Neuro_AI/Paper1/-/Comment', 'NeurIPS.cc/2019/Workshop/Program_Transformations/Paper4/-/Public_Comment',  # noqa
                   'NeurIPS.cc/2019/Workshop/Program_Transformations/Paper4/-/Official_Comment', 'NeurIPS.cc/2019/Workshop/Program_Transformations/-/Recruit_Reviewers']  # noqa

if __name__ == '__main__':
    client = openreview.Client(baseurl='https://openreview.net')
    download(client=client, invitation='NeurIPS.cc/2019/Workshop/Deep_Inverse')
    # download(client=client, invitation='NeurIPS.cc/2019/Workshop/Neuro_AI')
    # download(client=client, invitation='NeurIPS.cc/2019/Workshop/DC_S2')
