...
def download(client, invitation):
    ...
    # For every paper (forum), get the review ratings, the decisions,
    # and the paper's content
    data = []
    ...
    for forum in submissions_by_forum:
        ...
        with open("../data/NeurIPS.cc2019_DocIntelli_data/" + file_name + '_' + str(forum) + '.json', 'w') as file_handle:  # noqa
...
if __name__ == '__main__':
    ...
    download(client=client,
             invitation='NeurIPS.cc/2019/Workshop/Document_Intelligence')
