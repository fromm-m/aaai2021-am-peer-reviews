...
def download(client, invitation):
    ...
    for forum in submissions_by_forum:
        ...
        with open("../data/NeurIPS.cc2019_DCS1_data/" + file_name + '_' + str(forum) + '.json', 'w') as file_handle:  # noqa
...
if __name__ == '__main__':
    ...
    download(client=client, invitation='NeurIPS.cc/2019/Workshop/DC_S1')
